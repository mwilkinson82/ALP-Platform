        ...
        <div className="min-h-screen bg-white">
          ...
          <div className="flex">
            <aside className="hidden md:block w-64 bg-gray-100 p-4 space-y-2">
              <button onClick={() => router.push('/hub')} className="block w-full text-left p-2 hover:bg-gray-200 rounded">
                Dashboard
              </button>
              <button onClick={() => router.push('/hub/history')} className="block w-full text-left p-2 hover:bg-gray-200 rounded">
                History
              </button>
              <button onClick={() => router.push('/hub/services')} className="block w-full text-left p-2 hover:bg-gray-200 rounded">
                Services
              </button>
            </aside>
